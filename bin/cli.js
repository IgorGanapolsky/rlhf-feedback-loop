...
function proNudge() {
  ...
  process.stderr.write(
    '\n💡 Like this? Go Pro — hosted dashboard, auto-gate promotion, unlimited gates. $49/mo.\n' +
    `   → ${PRO_URL}\n\n`
  );
}
...
function pro() {
  ...
  console.log('─'.repeat(50));
  console.log('Self-serve offer today: Pro ($49/mo recurring).');
...
function help() {
  ...
  console.log('  pro                   Show Pro plan ($49/mo) + hosted pilot info');
