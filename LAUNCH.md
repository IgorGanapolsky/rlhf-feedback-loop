...
- **Pro tier ($10/mo)**: Auto-gate promotion, unlimited custom gates, multi-repo sync, CI webhook auto-ingest, priority support.
...
> Pro ($10/mo): auto-gate promotion, unlimited custom gates, multi-repo sync
>
...
>
> Free OSS core with 5 built-in gates. Pro at $10/mo adds auto-gate promotion, unlimited custom gates, and multi-repo sync.
>
> GitHub: https://github.com/IgorGanapolsky/mcp-memory-gateway"
...
>
> Free + MIT licensed. Pro at $10/mo for teams that need auto-gate promotion and multi-repo sync.
>
> https://github.com/IgorGanapolsky/mcp-memory-gateway"

## 4. High-Intent Direct Messages

> "Hey, I just shipped Pre-Action Gates in MCP Memory Gateway v0.7.0 — configurable checkpoints that block dangerous AI agent tool calls before they fire. The OSS core has 5 built-in gates and feedback capture for free. Pro is $10/mo for auto-gate promotion and multi-repo sync. Would love your honest feedback: https://github.com/IgorGanapolsky/mcp-memory-gateway"
