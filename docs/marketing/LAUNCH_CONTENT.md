...
I built project memory and guardrails for coding agents that implements:
...
**Message:**
🚀 Just launched **MCP Memory Gateway**. It gives MCP-compatible coding agents project memory, guardrails, and proof-backed runs.
