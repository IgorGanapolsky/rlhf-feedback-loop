...
If you already have one workflow that keeps hitting the same failure pattern, I can send the sprint brief and the proof pack.
...
- Sprint brief: https://github.com/IgorGanapolsky/mcp-memory-gateway/blob/main/docs/WORKFLOW_HARDENING_SPRINT.md
- Product + proof path: https://rlhf-feedback-loop-production.up.railway.app
